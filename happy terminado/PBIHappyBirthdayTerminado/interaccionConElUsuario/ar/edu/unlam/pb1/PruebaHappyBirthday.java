...
public class PruebaHappyBirthday {
	...
	private static void crearNuevoCumple(Cumpleaniero actual) {
		...
		System.out.println("Ingrese cuantos anios cumple");
	...
	private static void invitar(Cumpleaniero actual) {
		...
		System.out.println("Ingrese al cumpleanios que desea invitarlo");
		aQueCumple = teclado.nextInt();
		System.out.println(actual.getCumpleanios(aQueCumple).toString());
	...
	private static void confirmar(Cumpleaniero actual) {
		...
		System.out.println("Ingrese a que cumpleanios desea confirmar asistencia");
